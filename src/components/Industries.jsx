...
const Industries = () => {
  return (
    <div className="p-4 lg:px-64 md:pt-64">
      <div className="">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        <div className="p-4   border-8 m-5 flex flex-col items-center border-[#ffffff] shadow-lg bg-[#ffffff] rounded-md w-48 h-40">
          <img
        ...
        <div className="p-4 border m-5 flex flex-col items-center shadow-lg bg-[#ffffff] rounded-md w-48 h-40">
          <img
        ...
        <div className="p-4 border m-5 flex flex-col items-center bg-[#ffffff] shadow-lg rounded-md w-48 h-40">
          <img
